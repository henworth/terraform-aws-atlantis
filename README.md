...
| <a name="input_atlantis_github_app"></a> [atlantis\_github\_app](#input\_atlantis\_github\_app) | Whether to setup as a GitHub app or not | `bool` | `false` | no |
...
| <a name="input_manage_secrets"></a> [manage\_secrets](#input\_manage\_secrets) | Whether to manage the secret values or not | `bool` | `false` | no |
